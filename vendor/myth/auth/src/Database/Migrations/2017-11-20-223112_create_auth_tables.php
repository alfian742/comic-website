...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        // Combine the random number with the "User" prefix
        $randomFullname = 'User' . $randomNumber;
        ...
        $this->forge->addField([
            ...
            'fullname'         => ['type' => 'varchar', 'constraint' => 255, 'default' => $randomFullname],
            'user_img'         => ['type' => 'varchar', 'constraint' => 255, 'default' => 'default_profile.svg'],
